...
const calcPageTpl = `<div class="page" data-name="calc">${tmp}<div class="page-content">
  ...
  <div data-name="calcBoard" style="margin: 16px 8px 0 8px;">
    <div style="width: 24%; display: inline-flex; flex-direction: column;">
      <button style="width: 100%; height: 30px; margin-bottom: 8px; user-select: none;">Бу</button>
      <button style="width: 60%;  height: 30px; margin-bottom: 8px; user-select: none;">ку</button>
      <button style="width: 100%; height: 30px; margin-bottom: 8px; user-select: none;">Лу</button>
      <button style="width: 60%;  height: 30px; margin-bottom: 8px; user-select: none;">ну</button>
      <button style="width: 100%; height: 30px; margin-bottom: 8px; user-select: none;">Су</button>
      <button style="width: 60%;  height: 30px; margin-bottom: 8px; user-select: none;">ту</button>
      <button style="width: 100%; height: 30px; margin-bottom: 8px; user-select: none;">Фу</button>
      <button style="width: 100%; height: 30px; margin-bottom: 8px; user-select: none;">Му</button>
      <button style="width: 60%;  height: 30px; margin-bottom: 8px; user-select: none;">пу</button>
      <button style="width: 100%; height: 30px; margin-bottom: 8px; user-select: none;">Ру</button>
      <button style="width: 60%;  height: 30px; margin-bottom: 8px; user-select: none;">жу</button>
      <button style="width: 100%; height: 30px; margin-bottom: 8px; user-select: none;">Ду</button>
  </div>      
  <div style="width: 24%; display: inline-flex; flex-direction: column;">
    <button style="height: 30px; margin-bottom: 8px; user-select: none;">Бо</button>
    <button style="height: 30px; margin-bottom: 8px; user-select: none;">ко</button>
    <button style="height: 30px; margin-bottom: 8px; user-select: none;">Ло</button>
    <button style="height: 30px; margin-bottom: 8px; user-select: none;">но</button>
    <button style="height: 30px; margin-bottom: 8px; user-select: none;">Со</button>
    <button style="height: 30px; margin-bottom: 8px; user-select: none;">то</button>
    <button style="height: 30px; margin-bottom: 8px; user-select: none;">Фо</button>
    <button style="height: 30px; margin-bottom: 8px; user-select: none;">Мо</button>
    <button style="height: 30px; margin-bottom: 8px; user-select: none;">по</button>
    <button style="height: 30px; margin-bottom: 8px; user-select: none;">Ро</button>
    <button style="height: 30px; margin-bottom: 8px; user-select: none;">жо</button>
    <button style="height: 30px; margin-bottom: 8px; user-select: none;">До</button>
  </div>    
  <div style="width: 24%; display: inline-flex; flex-direction: column;">
    <button style="height: 30px; margin-bottom: 8px; user-select: none;">Бо</button>
    <button style="height: 30px; margin-bottom: 8px; user-select: none;">ко</button>
  ...
  <div style="width: 24%; display: inline-flex; flex-direction: column; align-items: flex-end;">
    <button style="width: 100%; height: 30px; margin-bottom: 8px; user-select: none;">Ба</button>
    <button style="width: 60%;  height: 30px; margin-bottom: 8px; user-select: none;">ка</button>
    <button style="width: 100%; height: 30px; margin-bottom: 8px; user-select: none;">Ла</button>
    <button style="width: 60%;  height: 30px; margin-bottom: 8px; user-select: none;">на</button>
    <button style="width: 100%; height: 30px; margin-bottom: 8px; user-select: none;">Са</button>
    <button style="width: 60%;  height: 30px; margin-bottom: 8px; user-select: none;">та</button>
    <button style="width: 100%; height: 30px; margin-bottom: 8px; user-select: none;">Фа</button>
    <button style="width: 100%; height: 30px; margin-bottom: 8px; user-select: none;">Ма</button>
    <button style="width: 60%;  height: 30px; margin-bottom: 8px; user-select: none;">па</button>
    <button style="width: 100%; height: 30px; margin-bottom: 8px; user-select: none;">Ра</button>
    <button style="width: 60%;  height: 30px; margin-bottom: 8px; user-select: none;">жа</button>
    <button style="width: 100%; height: 30px; margin-bottom: 8px; user-select: none;">Да</button>
  </div>      
